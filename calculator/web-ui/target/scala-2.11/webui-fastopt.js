...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, delta$1) {
    return (function() {
      return $m_Lcalculator_Polynomial$().findRoots__D__D__D__sci_Set($uD(a$2.apply__O()), $uD(b$2.apply__O()), $uD(delta$1.apply__O()))
    })
  })(a, b, delta));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_Polynomial$.prototype.findRoots__D__D__D__sci_Set = (function(a, b, delta) {
  if ((delta < 0)) {
    return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
  } else {
    var array = [(((-b) + $uD($g.Math.sqrt(delta))) / (2 * a)), (((-b) - $uD($g.Math.sqrt(delta))) / (2 * a))];
...
$c_Lcalculator_TweetLength$.prototype.calculator$TweetLength$$getColor__I__T = (function(remaingCharsCount) {
  return ((remaingCharsCount >= 15) ? "green" : (((remaingCharsCount >= 0) && (remaingCharsCount <= 14)) ? "orange" : "red"))
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      return $m_Lcalculator_TweetLength$().calculator$TweetLength$$getColor__I__T($uI(remainingCharsCount$1.apply__O()))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__Lcalculator_Signal__Lcalculator_Signal = (function(expr) {
  $m_Lcalculator_Signal$();
  var expr$2 = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, expr$1) {
    return (function() {
      return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(expr$1.apply__O()), arg$outer.namedExpressions$1$f)
    })
  })(this, expr));
  return new $c_Lcalculator_Signal().init___F0(expr$2)
});
...
$c_sc_MapLike$MappedValues.prototype.iterator__sc_Iterator = (function() {
  ...
  var this$3 = new $c_sc_Iterator$$anon$13().init___sc_Iterator__F1(this$1, p);
